...
while($user= mysqli_fetch_assoc($result))   { 
    ?>
    <form class="" action="editproduct2.php" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="<?php echo $user['id']?>">
            ...
            <div class="input-box">
                <img width="100" height="100" src="images/plants<?php echo $user['image']; ?>">
