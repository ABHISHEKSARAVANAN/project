<?php
    ...
    if(isset($_GET["delete_id"])) {
        ...
        $query="DELETE FROM accessories WHERE id=$delete_id";
        $result = mysqli_query($conn, $query);
        header("location:editaccessories.php");
        exit();
    }
...
<body style="background-color: #E8EFFA;">
    <div class="container " style="height: auto;margin-bottom: 50px;">
        <h2 style="text-align:center;margin-top:20px;color:#30694B;">ACCESSORIES DETAILS</h2>
        <br>
     ...
     background-color: rgba(57, 160, 91, 0.363);
      margin-bottom: 20px;" >
                ...
                <?php
                    ...
                    <td style="text-align:center;"><img width="60" height="60" src="images/accessories/<?php echo $row['image']; ?>" ></td>
