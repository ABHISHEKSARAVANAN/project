...
<nav>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="dropdown-section">
                        ...
                        <a href="pineapple.php"style="color: #e63946; text-decoration:underline;">Pineapple Jam</a>
    ...
    <a href="cart.php"><i class="fa fa-shopping-cart" style="font-size:35px; color: #e52129; margin-top:20px;"></i><span style="font-size:20px; color: #e52129;" class="cart-count"><?php echo $count_cart; ?></span></a>
</nav>
...
<div class="container">
    <div class="inner-container">
        <div class="jam-pic">
            <?php
            $query = "SELECT image FROM mixedjam WHERE name='Pineapple Jam'";
        ...
        <div class="content">
            <?php
            $query = "SELECT * FROM mixedjam WHERE name='Pineapple Jam'";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
                while ($row = $result->fetch_assoc()) { ?>
...
<div class="you-may-also-like-container">
    <?php
    $query = "SELECT * FROM mixedjam WHERE id in (1, 2, 4)";
