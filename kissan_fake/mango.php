            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="dropdown-section">
                        ...
                        <a href="mango.php" style="color: #e63946; text-decoration:underline;">Mango Jam</a>
                    </div>
                    <div class="dropdown-section">
...
<div class="container">
    <div class="inner-container">
        <div class="jam-pic">
            <?php
            $query = "SELECT image FROM mixedjam WHERE name='Mango Jam'";
        ...
        <div class="content">
            <?php
            $query = "SELECT * FROM mixedjam WHERE name='Mango Jam'";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
                while ($row = $result->fetch_assoc()) { ?>
...
<div class="you-may-also-like-container">
    <?php
    $query = "SELECT * FROM mixedjam WHERE id in (1, 2, 3)";
