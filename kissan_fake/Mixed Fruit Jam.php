...
<nav>
    ...
    <a href="cart.php"><i class="fa fa-shopping-cart" style="font-size:35px; color: #e52129; margin-top:20px;"></i><span class="cart-count" style="font-size:20px; color: #e52129;"><?php echo $count_cart; ?></span></a>
</nav>
...
<div class="container">
    <div class="inner-container">
        <div class="jam-pic">
            <?php
            $query = "SELECT image FROM mixedjam WHERE name='MIXED FRUIT JAM'";
        ...
        <div class="content">
            <?php
            $query = "SELECT * FROM mixedjam WHERE name='MIXED FRUIT JAM'";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
                while ($row = $result->fetch_assoc()) { ?>
...
<div class="you-may-also-like-container">
    <?php
    $query = "SELECT * FROM mixedjam WHERE id in (2, 3, 4)";
