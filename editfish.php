<?php
    ...
    if(isset($_GET["delete_id"])) {
        ...
        $query="DELETE FROM fish WHERE id=$delete_id";
...
<body style="background-color: #E8EFFA;">
    <div class="container " style="height: auto;margin-bottom: 50px;">
        <h2 style="text-align:center;margin-top:20px;color:#30694B;">Fish DETAILS</h2>
        <br>
     ...
     background-color: rgba(57, 160, 91, 0.363);
      margin-bottom: 20px;" >
                ...
                <?php
                    ...
                    <td style="text-align:center;"><img width="60" height="60" src="images/fish/<?php echo $row['image']; ?>" ></td>
