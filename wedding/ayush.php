...
<body>
    ...
    <div class="month" >
        <h1 style="text-align:center;color:#3F454A">Weddings Of Ayush & Prapthi</h1><br><br>
        <div class="grid-container">
        <div class="grid-item">
            <img style="height:auto" src="images/couples/ayushprapthi.jpg" ><br>
            <img style="height:800px" src="images/couples/ayush4.jpg" >
        </div>
        <div class="grid-item">
            <img src="images/couples/ayush2.jpg" style="height:auto"><br>
            <img src="images/couples/ayush3.jpg"  style="height:auto">
            
        </div>
        <div class="grid-item">
            <img src="images/couples/ayush5.jpg" style="height:800px"><br>
            <img src="images/couples/ayush6.jpg" style="height: 580px;">
        </div>
