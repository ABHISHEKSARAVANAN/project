...
if (isset($_POST["add"])) {
    ...
    $qur = "SELECT stock FROM accessories WHERE name='$name'";
...
<div class="navi" >
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <div class="dropdown-section">
                ...
                <a href="accessories.php"style="color: #30694B; text-decoration:underline;">Aquarium Accessories</a>
                <a href="#">Fish Food</a>
  ...
  <div class="right">
    ...
    <h2 style="text-align: center;margin-bottom:20px;margin-top:20px">Aquatic Accessories</h2>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) { ?>
            <form action="index.php" method="post">
                ...
                <div class="inner-box">
                    <img src="images/accessories/<?php echo $row["image"]; ?>" alt=""><br><br>
...
Aquarium Accessories provide your fish tank with required oxygen, takes care of the filtration, to adjust the temperature, also built automated feeding capabilities for your loved ones with out fail. 
It also helps for the  aquarium to have a professional look. Watching aquarium fish swim around the tank keeps us relaxing and have a amazing time. But you should have your aquarium been cleaned on a regular basis to avoid diseases to affect your loved ones. An heater will help to keep the temperature right, measured with the help of thermometer.
 Aquarium decorations will help in change the way in aquarium looks and have a fresh surroundings. For creating water circulation use Air pumps and internal filters.
 Use different Aquarium fish online Accessories to make your fish family have a nice and peaceful environment.</p>
