<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $folder='images/plants'.$productimage;
        $price = $_POST['price'];

        $stock=$_POST['stock'];
        $description=$_POST['description'];
        $query="INSERT INTO plants (image ,name, stock,description,price ) VALUES('$productimage','$productname','$stock','$description','$price')";
...
<body>
    <h1 style="text-align: center;color:#30694B;" >Insert Plants</h1>
