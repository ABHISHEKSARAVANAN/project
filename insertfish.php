<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $folder='images/fish'.$productimage;
        $price = $_POST['price'];
        $type = $_POST['type'];

        $stock=$_POST['stock'];
        $description=$_POST['description'];
        $query="INSERT INTO fish (image ,name, stock,description,price,type ) VALUES('$productimage','$productname','$stock','$description','$price','$type')";
        if(move_uploaded_file($tempname,$folder)){
        if(mysqli_query($conn,$query)){
            echo "<script>alert('Data entered successfully')</script>";
            echo "<script>window.location.href='insertfish.php'</script>";
...
<body>
    <h1 style="text-align: center;color:#30694B;" >Insert Fish</h1>
...
<form class="" action="" method="post" autocomplete="off" enctype="multipart/form-data">
        <div class="user-details">
            <div class="input-box">
                ...
                <span class="details">Fish Name : </span>
